...
public class DLinkedListTestMain {
	...
	public static void main(String[] args) {
		...
		list.insertAtEnd(10);
		list.insertAtEnd(5);
		list.insertbyPosition(5,30);
		System.out.println(list.printElements());
		
	//	list.deletByPosition(4);
		
		list.removeNodeMatched(new DLLNode(15));
	//	list.deleteAtEnd();
		...
		do {
			...
			case 6:
				...
				break;
			case 7:
				list.removeNodeMatched(new Node(scan.nextInt()));
				System.out
						.println("Remove a node matching the specified Node from the list");
				break;
			case 8:
